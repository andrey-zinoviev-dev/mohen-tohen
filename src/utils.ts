...
export const stepsOfProcess:{title: string, descirption: string}[] = [
  ...
  {
    title: "Экспертиза от архитекторов-дизайнеров",
    descirption: "Проведение экспертной оценки состояния объекта и возможных улучшений. Анализ текущей рыночной ситуации, включая цены на аналогичные объекты. Общение с риелторами для получения экспертной оценки и рекомендаций."
  },
  {
    title: "Создание альбома декор-концепции",
    descirption: "Разработка концепции декора, включающей выбор мебели, освещения и аксессуаров. Подготовка визуального альбома с предложенными решениями и вариантами оформления помещения. У вас на руках будет готовый дизайн-альбом."
  },
  {
    title: "Примерка декора и финальная расстановка",
    descirption: "Выезд нашего декоратора на объект для примерки и окончательного согласования декора. Расстановка мебели, аксессуаров и элементов декора в соответствии с разработанной концепцией. Подготовка пространства 'под ключ' для фотосессии и презентации потенциальным покупателям или арендаторам."
  }
]
