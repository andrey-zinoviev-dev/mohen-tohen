        ...
        <section className="good">
            ...
            <div className="good__text">
                ...
                <div className="good__text-buttons">
                    <BasketButton good={{title: good.title, _id: good._id, seller: good.seller, batch: good.batch, cover: good.photos && good.photos[0], price: good.price, quantity: quantity, selectedColor, selectedDimension, selectedMaterial}} />
