                ...
                <div className="application__wrapper_welcome">
                    ...
                    <div className="application__first-stage">
                        ...
                        <div className="application__wrapper_welcome-text">
                            ...
                            <p>Мы рады приветствовать Вас на платформе предметного декора, специально созданной для частных проивзодителей и малого бизнеса</p>
                            {/* <p>Вот несколько преимуществ работы с нами</p> */}
                            ...
                            <ul className="application__first-stage-ul">
                                <li>
                                    <p>
                                        ...
                                        Поможем подобрать
                                        стильные фото, отражающие характер вашей продукции,
                                        
                                         или создадим новые для привлечения большего количества покупателей
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        Доверие к продукции и ее узнаваемость.
                                        Помогаем составить полные и точные описания каждого товара, включая материалы, размеры и особенности ухода, а так же публикуем реальные отзывы клиентов
                                    </p>
                                </li>
                                <li>
                                    <p>
                                        Снижение Вашей нагрузки при создании товара.
                                        Берем на себя все общение с покупателями и решение спорых вопросов
                                    </p>
                                </li>
                                ...
                                {/* <li>Проефссиональная съемка вашего товара для размещения на платформе</li> */}
